...
base_speaker_tts.tts(input_text, src_path, speaker='cheerful', language='English', speed=1.1)  # Change 'dynamic' to your preferred base speaker

encode_message = "@MyShell"  # Replace this with the appropriate message or leave as is

# Convert using tone color converter with reference speaker style
